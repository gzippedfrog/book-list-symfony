 ...
 */
final class Version20230715201442 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT NOT NULL, title VARCHAR(255) NOT NULL, isbn VARCHAR(255) DEFAULT NULL, page_count INT DEFAULT NULL, published_date TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, thumbnail_url VARCHAR(255) DEFAULT NULL, short_description TEXT DEFAULT NULL, long_description TEXT DEFAULT NULL, status VARCHAR(255) NOT NULL, authors TEXT NOT NULL, PRIMARY KEY(id))');
